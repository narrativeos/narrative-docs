 ...
 * @Date: 2026-05-30 11:53:45
 * @LastEditors: Future Meng futuremeng@gmail.com
 * @LastEditTime: 2026-06-03 10:11:50
 * @FilePath: /narrativeos/narrative-docs/index.md
...
- [首个可复现案例（E2E 样例包）](user/getting-started/first-success-e2e-sample.md)
- [开发环境 10+15 分钟自检](developer/setup/README.md)
- [API 契约 15 分钟验证](developer/api/README.md)
...
- [Developer 开发者](developer-overview.md)
  - [Architecture 架构](architecture-overview.md)
- [User 用户](user-overview.md)
- [Academic 学术研究](academic-overview.md)

开发者专题入口已统一收敛到 Developer 分区，包含 AI 协作、ADR 决策与 Governance 治理标准。
...
- 如果你是开发者并需要协作规范：先进入 [developer-overview.md](developer-overview.md)，再按角色路径进入 AI、ADR 与 Governance 专题。
...
其中 [developer/coding/core-docs-mapping.md](developer/coding/core-docs-mapping.md) 和 [developer/coding/readiness-checklist.md](developer/coding/readiness-checklist.md) 更接近附录与终校材料，不属于白皮书正文主线。
