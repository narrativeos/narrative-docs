...
- 想按标准梳理文档：看 [project-docs-overview.md](project-docs-overview.md) 的“标准参考（Whitepaper）”
- 想参与治理：看 [developer/coding/docs-governance-standard.md](developer/coding/docs-governance-standard.md)
