...
V1 执行约束：作者/编辑路径必须满足 [../v1-design-baseline.md](../../developer/coding/v1-design-baseline.md) 定义的 In/Out Scope 与双门槛验收规则。
...
- 产品承接： [../modules/platform-domains.md](../../developer/coding/platform-domains.md), [../modules/library.md](../../product/modules/library.md)
