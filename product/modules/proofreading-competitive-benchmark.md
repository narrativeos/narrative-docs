...
本页定义 NarrativeOS 校对补齐能力的对外产品设定与竞争力边界。

核心立场：校对能力是 NarrativeOS 的必要补充与本地增强，不是对第三方校对产品的完全替代。

## Executive Summary (EN)

This document defines the external product positioning and competitive boundary for NarrativeOS proofreading enhancement.
...
- 角色与边界定义： [proofreading-capability-gap-closure-plan.md](proofreading-capability-gap-closure-plan.md)
