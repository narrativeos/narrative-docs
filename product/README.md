...
- [插件端功能说明](products/editor-plugin.md)（建设中）
...
- [Studio 工作台说明](products/narrative-studio.md)（建设中）
...
- [OS 治理引擎说明](../developer/narrative-os-core.md)（建设中）
...
| 你的角色 | 推荐阅读 |
|---------|---------|
| 日常用户（工程师/技术员） | [插件端功能说明](products/editor-plugin.md) |
| 领域专家（知识工程师） | [Studio 工作台说明](products/narrative-studio.md) |
| 平台运营/治理负责人 | [OS 治理引擎说明](../developer/narrative-os-core.md) |
| 产品经理 | [产品愿景](vision/README.md) → [路线图](roadmap/README.md) |
| 投资人/决策者 | [机械加工手册杀手级场景](scenarios/machining-handbook-killer-scenario.md) |
...
- [products/editor-plugin.md](products/editor-plugin.md): LibreOffice/Word 插件端 — 日常办公中的智能助手
- [products/narrative-studio.md](products/narrative-studio.md): NarrativeStudio 专家工作台 — 知识图谱构建与归档
- [../developer/narrative-os-core.md](../developer/narrative-os-core.md): NarrativeOS Core 底层大脑 — 知识时序治理引擎

### 应用场景

- [scenarios/machining-handbook-killer-scenario.md](scenarios/machining-handbook-killer-scenario.md): 机械加工手册杀手级场景 — 非线性组合检索、证据溯源、插件嵌入式体验
...
- 平台域模块设计 → [developer/coding/platform-domains.md](../developer/coding/platform-domains.md)

### 开发计划（已迁移至 Developer 分区）

- V1 设计基线 → [developer/coding/v1-design-baseline.md](../developer/coding/v1-design-baseline.md)
- V1 两周迭代计划 → [developer/coding/v1-two-week-sprint-plan.md](../developer/coding/v1-two-week-sprint-plan.md)
