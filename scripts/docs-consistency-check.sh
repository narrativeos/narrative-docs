...
require_anchor_followed_by() {
  local f="$1"
  local anchor="$2"
  local expected="$3"
  local window="${4:-30}"
  awk -v anchor="$anchor" -v expected="$expected" -v window="$window" '
    index($0, anchor) {
      for (i = 0; i < window && getline nextline; i++) {
    ...
    END { exit(found ? 0 : 1) }
  ' "$f" || fail "expected pattern not found within $window lines after anchor in $f: $anchor -> $expected"
...
require_file "academic/fact-verification-protocol.md"
require_file "academic/fact-verification-method-stack.md"
require_file "academic/templates-golden-set-fact-check-ledger.md"
...
require_contains "academic/fact-verification-protocol.md" "Fact Verification Protocol"
require_contains "academic/fact-verification-method-stack.md" "Fact Verification Method Stack"
require_contains "academic/templates-golden-set-fact-check-ledger.md" "Golden Set Template: Fact Check Ledger"
require_contains "academic/examples-golden-set-fact-check-ledger-minimal.md" "Example: Golden Set Fact Check Ledger Minimal"
require_contains "academic/templates-golden-set-change-review.md" "fact_gate_decision: pass | fail"
require_contains "academic/templates-golden-set-change-review.md" "fact_check_ref: <path-or-id>"
require_contains "academic/templates-golden-set-release-ledger.md" "blocked_by_fact_check: <count>"
require_contains "academic/templates-golden-set-release-ledger.md" "fact_gate_decision: pass | fail"
require_contains "academic/examples-golden-set-release-ledger-minimal.md" "release_go_no_go: no-go"
require_contains "academic/examples-golden-set-change-review-minimal.md" "fact_gate_decision: fail"
...
require_contains "academic/golden-set-field-dictionary.md" "rebound_to_discovery"
require_contains "academic/golden-set-field-dictionary.md" "update_grounding_baseline"
require_contains "academic/golden-set-field-dictionary.md" "fact_gate_decision"
require_contains "academic/golden-set-field-dictionary.md" "fact_check_ref"
...
require_contains "product/workflows/proofreading-competitive-benchmark-checklist.md" "Proofreading Competitive Benchmark Checklist"
require_contains "product/workflows/proofreading-competitive-benchmark-checklist.md" "DS-V1-PRF-P0-001"
require_contains "product/workflows/proofreading-competitive-benchmark-checklist.md" "DS-V1-PRF-P1-001"
require_contains "product/workflows/proofreading-competitive-benchmark-checklist.md" "DS-V1-PRF-P2-001"
require_contains "product/workflows/proofreading-competitive-benchmark-checklist.md" "P0=standard, P1=standard, P2=strict"

require_contains "product/workflows/proofreading-competitive-benchmark-run-record-template.md" "Proofreading Competitive Benchmark Run Record Template"
...
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "Proofreading Competitive Results Sample"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "DS-V1-PRF-P0-001"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "DS-V1-PRF-P1-001"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "DS-V1-PRF-P2-001"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "product/workflows/proofreading-competitive-benchmark-runbook.md"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "product/workflows/proofreading-competitive-benchmark-checklist.md"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "proofreading-competitive-benchmark-run-record-template.md"
require_contains "whitepaper/proofreading-competitive-results-sample-2026-05.md" "从样例升级到真实试点数据"
...
require_contains "assets/doc-index.yaml" "academic/fact-verification-protocol.md"
require_contains "assets/doc-index.yaml" "academic/fact-verification-method-stack.md"
require_contains "assets/doc-index.yaml" "academic/templates-golden-set-fact-check-ledger.md"
