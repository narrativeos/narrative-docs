...
这一分区用于说明项目如何协作、如何发布、以及哪些规则构成对外宣称的边界。

如果你只是第一次了解 NarrativeOS，不必从这里开始；治理层更适合贡献者、维护者和评审者在需要核对规则时使用。
...
- 以下文档用于定义“哪些判断可以说、哪些能力何时可以发布”的依据。
...
- [Documentation Governance Monthly Check Template](developer/coding/docs-governance-monthly-check-template.md)
