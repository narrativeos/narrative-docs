...
| PRF-001 | trial | [proofreading-competitive-results-template.md](proofreading-competitive-results-template.md), [proofreading-competitive-results-sample-2026-05.md](proofreading-competitive-results-sample-2026-05.md) | 校对补齐竞争力验证真实试点结果回填入口已建立（按平台域融合口径） | documented | Source: product/modules/platform-domains.md + product/workflows/proofreading-competitive-benchmark-runbook.md + checklist + run record template; pending first real pilot run |
...
| P0 | PRF-002 | trial | 补 1 轮校对补齐真实试点竞争力验证记录（含域责任映射） | product/modules/platform-domains.md, product/workflows/proofreading-competitive-benchmark-runbook.md, checklist, run record, whitepaper result page |
...
inputs:
	...
	- 结果摘要
source_policy:
	- 不依赖单一入口；期刊官网、DOI 落地页、开放数据库均可作为正式来源线索
