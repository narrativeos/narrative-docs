...
| PRF-001 | trial | [proofreading-competitive-results-template.md](proofreading-competitive-results-template.md), [proofreading-competitive-results-sample-2026-05.md](proofreading-competitive-results-sample-2026-05.md) | 校对补齐同题对打真实试点结果回填入口已建立 | documented | Source: product/workflows/proofreading-competitive-benchmark-runbook.md + checklist + run record template; pending first real pilot run |
...
| P0 | PRF-002 | trial | 补 1 轮校对补齐真实试点对打记录 | product/workflows/proofreading-competitive-benchmark-runbook.md, checklist, run record, whitepaper result page |
