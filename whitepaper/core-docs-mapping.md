...
| 07 开源治理与协作模型 | [GOVERNANCE.md](../GOVERNANCE.md), [developer/README.md](../developer/README.md), [ai/repo-rules/README.md](../ai/repo-rules/README.md), [CODE_OF_CONDUCT.md](../CODE_OF_CONDUCT.md) | 基本完成 | 已具备治理、角色与行为准则基础 |
| 08 安全、隐私与合规 | [SECURITY.md](../SECURITY.md), [architecture/system/README.md](../architecture/system/README.md), [user/cloud/README.md](../user/cloud/README.md) | 基本完成 | 已具备漏洞披露与响应时限策略 |
